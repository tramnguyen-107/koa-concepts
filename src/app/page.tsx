      ...
      <section style={{ background: '#B8906F', padding: '88px 24px' }}>
        <div style={{ maxWidth: 560, margin: '0 auto', textAlign: 'center' }}>
          ...
          {emailDone ? (
            ...
            <form onSubmit={async e => { e.preventDefault(); const form = e.target as HTMLFormElement; const email = (form.elements.namedItem('email') as HTMLInputElement).value; const result = await subscribeNewsletter(email); if (!result.success) { alert('Error: ' + result.error); return; } setEmailDone(true); }}
